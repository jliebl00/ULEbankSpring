...
public class DNIHandler implements Handler {
	...
	public DNIHandler(String dni) throws MalformedHandlerException {
		...
		if (dni == null) {
			...
			throw new MalformedHandlerException("Bad DNI: ".concat(error
					.toString()));
			...
			Integer dniNumber = Integer.parseInt(dni.substring(0,
					dni.length() - 1));
	 ...
	 * @throws MalformedHandlerException
	 */
	public DNIHandler(char foreingLetter, int dni, char letter)
			throws MalformedHandlerException {
